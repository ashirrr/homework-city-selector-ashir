...
*  [traffic light](http://codepen.io/barryross/pen/pjqwym) 
  * introduction to functions & js
  * changing css properties with javascript

*  [FAQ](http://codepen.io/barryross/pen/bVORpm)
  *  practice with functions
  *  toggle() and slideToggle() methods

* [color switcher](http://codepen.io/barryross/pen/GpXYVw)
   * introduction to jQuery functions and .css() method

*  [Blackout](http://codepen.io/barryross/pen/yYGXJd) 
  *  conditionals
  *  using classes to convey state

* [dom-selectors exercise](http://codepen.io/barryross/pen/GpPEjQ)
  *  practice with selectors

* [Score-keeper](http://codepen.io/barryross/pen/xwmrRE)
  *  planning a program to achieve desired goal/functionality
  *  variables
  *  arithmetic operators 

*  walk-through video from assignment #3
(coming soon!)
...
By week 5, you should have submitted a proposal and wireframes for your final project. Next up, you'll be writing pseudo code for the interactivity you would like to add.  For this week, you should begin writing psuedo code and a draft of the HTML/CSS for your application - this should be turned into your instructor by the beginning of week 7 (Tuesday, Nov. 24th).
